...
| 7차 | 계획서 및 발표 자료 작성 | 2026.04.13 | 2026.04.23 |  100% |
...
| 역할 | 담당 영역 |
|------|-----------|
| palantir1997 | 서버 설계, 전체 시스템 설계, 에러 핸들링, 프론트엔드, 문서 작성 |
| Jeongjaew0n1 | 서버 구축, DB 관리, 백엔드, 에러 핸들링 |
| Hong-ki-su | 웹 개발, 프론트엔드, 에러 핸들링 |
| jungee-11 | 네트워크 구축 및 발표 대본 작성|
