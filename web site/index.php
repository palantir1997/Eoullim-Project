...
<body class="d-flex">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid px-4">
            <h3 class="h4 mb-4 text-gray-800 fw-bold">Admin Dashboard - Network Status</h3>

            <div class="card shadow-sm mb-4 border-0">
                <div class="card-header py-3 bg-dark text-start">
                    <h6 class="m-0 fw-bold text-white"><i class="fas fa-server me-2"></i>Server Status Monitor</h6>
                </div>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-header py-3 bg-dark text-start">
                    <h6 class="m-0 fw-bold text-white"><i class="fas fa-user me-2"></i>My Active Session Info</h6>
                </div>
                <div class="card-body p-0">
                    <table class="table table-hover table-striped mb-0">
                        <tbody>
                            <tr><td class="fw-bold" style="width: 30%">접속 유저</td><td><?php echo $userId ? htmlspecialchars($userId) : 'Guest'; ?></td><td><span class="badge bg-success">Logged In</span></td></tr>
                ...
                <div class="card-body p-0">
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
                            <tr>
                                <th>User ID</th>
                                <th>Location (Current Page)</th>
                                <th>Client IP</th>
                                <th>Status</th>
                            </tr>
                        </thead>
                        <tbody id="onlineUserTable">
                            <tr><td colspan="4" class="text-center py-4">접속자 데이터를 불러오는 중...</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <script>
        ...
        function renderOnlineUsers(users) {
            ...
            users.forEach(user => {
                const row = `
                    <tr>
                        <td class="fw-bold"><i class="fas fa-user-circle me-2 text-gray-400"></i>${user.id}</td>
                        <td><span class="badge bg-light text-dark border">${user.page}</span></td>
